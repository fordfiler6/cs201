...
public class JButtonCustomDark extends JButton implements MouseListener
{
	private boolean mouseOver = false;
	private boolean mouseDown = false;
	public JButtonCustomDark()
	{
		 ...
		 if(mouseOver)
	        {
		 	...
		 	{
			 	color1 = Color.RGBtoHSB(240, 246, 251,null);
			 	color2 = Color.RGBtoHSB(214, 225, 239,null);
		 	}
